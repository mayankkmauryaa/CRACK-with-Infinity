...
- In the first query we need sum from 1 to 4 which is
  `1 + 2 + 3 + 4 = 10`.
- In the second query we need sum from 2 to 3 which is
  `2 + 3 = 5`.
...
- In the first query we need sum from 4 to 4 which is
  `29`.
- In the second query we need sum from 2 to 3 which is
  `30 + 48 = 78`.
