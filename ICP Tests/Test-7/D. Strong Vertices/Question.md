...
1. In the first line, output the number of strong vertices.
2. In the second line, output all strong vertices in ascending order.
...
The condition $a_u - a_v \ge b_u - b_v$ can be rewritten as $a_u - b_u \ge a_v - b_v$. Would you like me to explain how this mathematical simplification helps find the strong vertices in $O(n)$ time?
