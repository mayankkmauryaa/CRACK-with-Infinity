...
The second line contains the sequence $a_1, a_2, \dots, a_n$ ($0 \le a_i \le 10^6$), where $a_i$ is the number of visits to the $i$-th building.
...
On the second line print the sequence $x_0, x_1, \dots, x_n$ of $n+1$ integers, where $x_i$ ($-10^6 \le x_i \le 10^6$) is the selected coordinate of the $i$-th building. It can be shown that an optimal answer exists with coordinates not exceeding $10^6$.
